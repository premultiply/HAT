...
Color.prototype.toString = function(remove_alpha) {
  ...
  $('.hat-color-control').each(function() {
	var $control = $(this),
	...
	$('<div class="hat-alpha-container"><div class="slider-alpha"></div><div class="transparency"></div></div>').appendTo($control.parents('.wp-picker-container'));
